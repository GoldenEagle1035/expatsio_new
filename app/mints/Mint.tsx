...
//           <div className="absolute right-[14%] 2xl:top-[130px] lg:top-[100px] top-[70px] z-50">
...
//             </button>
//           </div>
//           <div className="text-white 2xl:text-3xl md:text-lg md:flex hidden text-sm bg-[#E91717] border-2 border-black rounded-lg p-3 absolute right-[15%] bottom-[25%]">
...
//             )}
//           </div>
//           <div className="absolute left-[18%] 2xl:top-[110px] top-[60px] z-40">
//             <Image
...
//                 <h2 className="jersey text-black 2xl:text-[64px] lg:text-4xl text-xs text-center">
//                   MINT NFT
//                 </h2>
...
//                     decoding="sync"
//                     loading="eager"
//                     className={`!relative 2xl:!w-[130px] lg:!w-24 !w-5 z-50 mr-4 border-4 border-white rounded-2xl shadow`}
//                     alt="Expatsio"
//                   />
//                   <div>
...
//                       Price Per NFT
//                     </p>
//                     <p className="text-black lg:text-3xl text-sm">0.0128 ETH</p>
//                   </div>
//                 </div>
...
//                     <button className="text-black px-2 lg:py-1 py-[1px] lg:text-base text-xs border-2 border-black rounded-l-lg">
//                       -
//                     </button>
//                     <input
//                       type="text"
...
//                       placeholder="1"
//                     />
//                     <button className="text-black border-2 border-black px-2 lg:py-1 py-[1px] lg:text-base text-xs rounded-r-lg">
//                       +
//                     </button>
//                   </div>
//                   <div className="bg-white border-2 border-black cursor-pointer hover:opacity-80 transition-all duration-300 flex justify-center items-center lg:h-8 h-6 px-4 rounded-lg">
//                     SET MAX
//                   </div>
//                 </div>
//               </div>
...
//                   <p className="lg:text-3xl text-xs text-white">TOTAL</p>
//                   <p className="lg:text-3xl text-xs text-white">0.0128 ETH</p>
//                 </div>
//                 <hr className="border border-white" />
//                 <div className="2xl:mt-5 lg:mt-4 mt-1 lg:w-[140px] w-[60px] 2xl:py-2 lg:py-1 py-[1px] 2xl:text-5xl text-base mx-auto bg-white border-2 border-black cursor-pointer hover:opacity-80 transition-all duration-300 flex justify-center items-center px-4 rounded-lg">
//                   MINT
//                 </div>
//               </div>
//             </div>
//             <div className="text-white 2xl:text-3xl md:text-lg md:hidden flex text-sm bg-[#E91717] border-2 border-black rounded-lg p-3 absolute right-[15%] bottom-[25%]">
//               Wallet not selected <br /> come back next phase
//             </div>
//           </div>
//         </div>
