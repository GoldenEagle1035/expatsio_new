            ...
            <div className="2xl:w-[510px] md:w-[400px] w-[300px] border-2 rounded-2xl border-black">
              <div className="w-full pb-1 border-t-2 border-white 2xl:pt-6 lg:pt-2 pt-[2px] bg-[#FFC6A6] px-4 relative rounded-t-2xl">
                ...
                <div className="2xl:mt-5 lg:mt-2 mt-1 mb-2 rounded-2xl border-2 px-4 lg:py-2 py-[2px] flex justify-between gap-4 items-center bg-[#fbdccb] border-black relative z-10">
                  ...
                  <div className="jersey font-bold text-xl bg-white border-2 border-black cursor-pointer hover:opacity-80 transition-all duration-300 flex justify-center items-center lg:h-8 h-6 px-4 rounded-lg">
                    SET MAX
                  </div>
                </div>
              </div>
              <div className="bg-[#A14A1F] 2xl:pb-4 lg:pb-2 pb-1 lg:pt-2 pt-1 px-4 rounded-b-xl relative z-10">
                ...
                <div className="flex justify-between gap-4 items-center lg:py-2 py-[2px]">
                  ...
                  <p className="lg:text-3xl text-base text-white">0.0128 ETH</p>
                </div>
                <hr className="border border-white" />
                <div className="font-bold 2xl:mt-5 lg:mt-4 mt-1 lg:w-[140px] w-[60px] 2xl:py-2 lg:py-1 py-[1px] 2xl:text-5xl text-base mx-auto bg-white border-2 border-black cursor-pointer hover:opacity-80 transition-all duration-300 flex justify-center items-center px-4 rounded-lg">
                  MINT
                </div>
              </div>
            </div>
